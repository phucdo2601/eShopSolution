...
namespace eShopSolution.Data.Extensions
{
    public static class ModelBuilderExtension
    {
        ...
        {
            /**
             * Tao ra datamau seeding data:
             * Khi tao ra data mau, du la bang co mang khoa chinh hay khoa ngoai thi cung phai field du truong thong tin
             */
            modelBuilder.Entity<AppConfig>().HasData(
                new AppConfig() { Key = "HomeTitle", Value = "This is home page of eShopSolution" },
                new AppConfig() { Key = "HomeKeyWork", Value = "This is home page of eShopSolution" },
            ...
            modelBuilder.Entity<AppUser>().HasData(
                new AppUser
                {
                    ...
                    NormalizedEmail = "ngocphucdo2601@gmail.com",
                    EmailConfirmed = true,
                    PasswordHash = hasher.HashPassword(null, "12345678@Abc"),
                    SecurityStamp = string.Empty,
                    FirstName = "Phuc",
                    LastName= "Do",
                    Dob = new DateTime(2000, 01, 20)
                }
                );
